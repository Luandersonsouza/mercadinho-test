...
def menu() -> None:
    print('===============================')
    print('==========Bem Vindo============')
    print('===Ao Mercado da dona Katia====')
    print('===============================')
    ...
    if opcao == 1:
        ...
        print('Volte Sempre.... Seu b...')
        sleep(2)
        exit(0)
    else:
        print('Opção Inválida!') #caso ele não digite de 1 a 6
        sleep(1)
        menu()
...
def cadastrar_produto() -> None:
    ...
    validade : str = input('Informe a data de validade do produto: ')

    produto: Produto = Produto(nome, preco, validade)
